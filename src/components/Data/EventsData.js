const eventsData = {
	...
	blockTexts: [
		{
			text: 'События в React именуются в стиле camelCase вместо нижнего регистра. С JSX вы передаёте функцию как обработчик события вместо строки.',
		},
		{
			text: 'HTML:',
			code: `
...
<button onClick={activateLasers}>
	Активировать лазеры
		...
		{
			text: 'Популярные обработчики событий: onClick, onChange, где обычно onClick - на button,а onChange - на input',
		},
		{
