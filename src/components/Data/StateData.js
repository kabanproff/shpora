const stateData = {
   ...
   blockTexts: [
      {
         text: [
            'State нужен для того, чтобы хранить какое-то изменяющее значение. Например, с которым будет взаимодействовать пользователь.',
            'Стейт обновляется всегда через setState()',
         ],
         code: `
